...
const SECTIONS = [
  ...
  },
  {
    icon: '📍',
    title: 'Location Data',
    body: `CareBridge collects your precise GPS location while you are online on the app. This is used to match you with nearby customers and to share your location with emergency contacts during an SOS event.\n\nYou can disable location access in your device settings, but this will prevent you from receiving booking requests.`,
  },
  {
    icon: '🤝',
    title: 'Data Sharing',
    body: `We do not sell your personal data. We share your information only with:\n• Customers (limited to name, rating, and service info)\n• Payment processors for earnings disbursement\n• Emergency contacts (location only during SOS)\n• Government authorities when required by law`,
  },
  {
    icon: '🔒',
    title: 'Data Security',
    body: `We use industry-standard encryption (TLS 1.3) to protect data in transit and AES-256 encryption for data at rest. Access to your data is restricted to authorised CareBridge personnel only. We conduct regular security audits and vulnerability assessments.`,
  },
  {
    icon: '📱',
    title: 'Data Retention',
    body: `We retain your account data for as long as your account is active. If you delete your account, we will permanently remove your personal data within 30 days, except where retention is required by law (e.g., financial records retained for 7 years per Indian tax regulations).`,
  },
  {
    icon: '✅',
    title: 'Your Rights',
  ...
  },
  {
    ...
    body: `The CareBridge app uses analytics tools to understand usage patterns and improve the user experience. We do not use third-party advertising trackers. You can opt out of analytics in Settings → App Preferences.`,
  },
]
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '20px 20px 32px' }}>
            ...
            <div style={{ background: '#EFF6FF', borderRadius: '16px', padding: '16px', border: '1px solid #BFDBFE' }}>
              ...
              <div style={{ fontSize: '13px', color: '#64748B', lineHeight: 1.55 }}>
                ...
                <span style={{ color: '#2563EB', fontWeight: 700 }}>privacy@carebridge.in</span>
