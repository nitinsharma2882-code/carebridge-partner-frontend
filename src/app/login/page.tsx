...
export default function LoginPage() {
  ...
  const handleSend = async () => {
    ...
    if (clean.length < 10) {
      showPopup({
        type: 'warning', title: 'Invalid Number',
    ...
    try {
      ...
      // For prototype — skip real API and go to OTP anyway
      storePhone(clean)
      router.push('/otp')
    } finally {
      setLoading(false)
          ...
          <div style={{ padding: '12px 28px 0', flex: 1 }}>
            ...
            <div style={{
              ...
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"
                  fill="#0D9488" fillOpacity="0.2" stroke="#0D9488" strokeWidth="1.5"/>
            ...
            <div style={{ marginTop: '32px' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  style={{
                    width: '100%', paddingLeft: '60px',
                    paddingRight: '16px', paddingTop: '15px', paddingBottom: '15px',
                  ...
                  onFocus={(e) => {
                    ...
                    e.target.style.background  = '#EDFAF7'
                  }}
                  onBlur={(e) => {
            ...
            <button
              ...
              style={{
                ...
                marginTop: '20px', transition: 'opacity 0.15s',
              }}
            >
            ...
            <p style={{
              ...
              color: '#94A3B8', marginTop: '20px', lineHeight: 1.7,
            }}>
...
// ── Inline Popup (no external import needed yet) ──────────
function PopupLayer() {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            textAlign: 'center', letterSpacing: '-0.3px', lineHeight: 1.3, margin: 0,
          }}>
            {popup.title}
          </h2>
        </div>
