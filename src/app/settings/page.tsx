      ...
      <div style={{ position:'absolute', inset:0, display:'flex', flexDirection:'column' }}>
        ...
        <div style={{ flex:1, overflowY:'auto', paddingBottom:'90px' }}>
          <div onClick={()=>router.push('/profile')} style={{ margin:'14px 14px 0', background:'#fff', borderRadius:'18px', padding:'14px 16px', display:'flex', alignItems:'center', gap:'13px', border:'1px solid #E2E8F0', cursor:'pointer' }}>
            ...
            <div style={{ flex:1 }}><div style={{ fontSize:'16px', fontWeight:800, color:'#0F172A' }}>Rajan Kumar</div><div style={{ fontSize:'13px', color:'#64748B', marginTop:'2px' }}>View & edit your profile →</div></div>
            <div style={{ width:'22px', height:'22px', borderRadius:'50%', background:'#DCFCE7', display:'flex', alignItems:'center', justifyContent:'center' }}><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#16A34A" strokeWidth="3" strokeLinecap="round"><polyline points="20 6 9 17 4 12"/></svg></div>
          </div>
