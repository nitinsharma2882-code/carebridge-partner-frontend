...
interface Tx {
  ...
  customer: string; date: string; duration: string
...
const tabData = {
  daily: {
    total: '₹1,240', subtitle: '↑ 18% more than yesterday',
    stats: [{ v: '5', l: 'Trips' }, { v: '₹248', l: 'Avg/trip' }, { v: '4.9★', l: 'Rating' }],
    bars: [
      { h: 48, l: 'Mon' }, { h: 65, l: 'Tue' }, { h: 38, l: 'Wed' },
      { h: 82, l: 'Thu' }, { h: 55, l: 'Fri' }, { h: 92, l: 'Sat' },
      { h: 70, l: 'Sun', active: true },
    ],
    chartTitle: 'Daily Earnings', chartRange: 'Mar 22–28',
    s1: '₹1,240', sl1: 'Today',
    s2: '₹248',   sl2: 'Avg/day',
    s3: '₹1,820', sl3: 'Best day',
  },
  weekly: {
    total: '₹8,640', subtitle: '↑ 12% vs last week · 28 trips',
    stats: [{ v: '28', l: 'Trips' }, { v: '₹308', l: 'Avg/trip' }, { v: '4.9★', l: 'Rating' }],
    bars: [
      { h: 60, l: 'W1' }, { h: 75, l: 'W2' }, { h: 45, l: 'W3' },
      { h: 88, l: 'W4' }, { h: 70, l: 'W5', active: true },
      { h: 55, l: 'W6' }, { h: 82, l: 'W7' },
    ],
    chartTitle: 'Weekly Earnings', chartRange: 'Mar 2026',
    s1: '₹8,640', sl1: 'This week',
    s2: '₹7,200', sl2: 'Last week',
    s3: '₹10,200', sl3: 'Best week',
  },
  monthly: {
    total: '₹31,200', subtitle: '↑ 8% vs last month · 104 trips',
    stats: [{ v: '104', l: 'Trips' }, { v: '₹300', l: 'Avg/trip' }, { v: '4.9★', l: 'Rating' }],
    bars: [
      { h: 50, l: 'Jan' }, { h: 65, l: 'Feb' },
      { h: 80, l: 'Mar', active: true }, { h: 55, l: 'Apr' },
    ],
    chartTitle: 'Monthly Earnings', chartRange: '2026',
    s1: '₹31,200', sl1: 'This month',
    s2: '₹8,200',  sl2: 'Avg/month',
    s3: '₹11,400', sl3: 'Best month',
  },
}
  ...
  return (
    <div onClick={(e) => { if (e.target === e.currentTarget) onClose() }}
      ...
      <div style={{ background: '#fff', borderRadius: '28px 28px 0 0', padding: '0 20px 36px', maxHeight: '85%', overflowY: 'auto' }}>
        ...
        <p style={{ fontSize: '14px', color: '#64748B', marginBottom: '20px', lineHeight: 1.55 }}>
          Transfer to SBI account ending <strong>4521</strong>
        </p>
        ...
        <div style={{ position: 'relative', marginBottom: '16px' }}>
          ...
          <input
            ...
            style={{ width: '100%', paddingLeft: '30px', paddingRight: '14px', paddingTop: '14px', paddingBottom: '14px', background: '#F1F5F9', border: '1.5px solid #E2E8F0', borderRadius: '12px', fontSize: '16px', color: '#0F172A', outline: 'none', fontFamily: 'DM Sans, sans-serif', boxSizing: 'border-box' }}
          />
        </div>
        ...
        <div style={{ background: '#F1F5F9', border: '1.5px solid #E2E8F0', borderRadius: '12px', padding: '13px 16px', marginBottom: '16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            <div style={{ fontSize: '14px', fontWeight: 700, color: '#0F172A' }}>SBI Savings Account</div>
            <div style={{ fontSize: '12px', color: '#64748B', marginTop: '2px' }}>•••• •••• •••• 4521</div>
          </div>
          <span style={{ background: '#DCFCE7', color: '#16A34A', fontSize: '11px', fontWeight: 700, padding: '4px 10px', borderRadius: '100px' }}>Primary</span>
        </div>
        <div style={{ background: '#FEF3C7', borderRadius: '12px', padding: '12px 14px', marginBottom: '20px', fontSize: '13px', color: '#D97706', lineHeight: 1.5 }}>
          ⏱ Processing time: 1–2 business days
        </div>
        <button onClick={confirm} style={{ width: '100%', padding: '16px', background: '#0D9488', border: 'none', borderRadius: '14px', color: '#fff', fontSize: '16px', fontWeight: 700, cursor: 'pointer', fontFamily: 'DM Sans, sans-serif', marginBottom: '10px' }}>
          Confirm Withdrawal →
        </button>
        <button onClick={onClose} style={{ width: '100%', padding: '15px', background: 'transparent', border: '1.5px solid #0D9488', borderRadius: '14px', color: '#0D9488', fontSize: '15px', fontWeight: 700, cursor: 'pointer', fontFamily: 'DM Sans, sans-serif' }}>
          Cancel
        </button>
      </div>
    </div>
...
export default function EarningsPage() {
  ...
  const openTx = (tx: Tx) => {
    showPopup({
      ...
      body: `Customer: ${tx.customer}\nDate: ${tx.date}\nDuration: ${tx.duration}\nRef: CB-${tx.id.toUpperCase()}`,
      icon: tx.icon,
      actions: [
        { label: 'Download Receipt', variant: 'primary',   fn: () => { closePopup(); toast('Receipt downloaded ✓') } },
  ...
  const toast = (msg: string) => {
    showPopup({
      type: 'success', title: msg, body: '', icon: '✅',
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto', paddingBottom: '90px' }}>
            ...
            <div style={{ margin: '14px 14px 12px', borderRadius: '22px', padding: '20px', background: 'linear-gradient(135deg,#065f52,#0D9488,#14b8a6)', color: '#fff', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ fontSize: '11px', fontWeight: 700, opacity: 0.75, letterSpacing: '0.8px', textTransform: 'uppercase' }}>
            ...
            <div style={{ display: 'flex', background: '#E2E8F0', borderRadius: '12px', padding: '3px', margin: '0 14px 14px' }}>
              {(['daily', 'weekly', 'monthly'] as Tab[]).map(t => (
                <button key={t} onClick={() => setTab(t)} style={{
                  flex: 1, padding: '9px', background: tab === t ? '#fff' : 'transparent',
                  border: 'none', borderRadius: '10px', fontSize: '13px', fontWeight: 700,
                  color: tab === t ? '#0D9488' : '#94A3B8', cursor: 'pointer',
                ...
                {d.bars.map((b, i) => (
                  <div key={i} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px', height: '100%', justifyContent: 'flex-end' }}>
                    <div style={{
                      ...
                      height: `${b.h}%`,
                      background: b.active ? '#0D9488' : '#CCFBF1',
                      border: b.active ? '2px solid #0F766E' : 'none',
                      transition: 'height 0.5s',
                    }} />
                    <div style={{ fontSize: '10px', fontWeight: b.active ? 700 : 600, color: b.active ? '#0D9488' : '#94A3B8' }}>
                      {b.l}
                    </div>
                  </div>
                ))}
            ...
            <div style={{ margin: '0 14px 12px', background: '#EDFAF7', borderRadius: '16px', padding: '14px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', border: '1px solid #CCFBF1' }}>
              <div>
                <div style={{ fontSize: '13px', fontWeight: 700, color: '#0F172A' }}>Pending Withdrawal</div>
                <div style={{ fontSize: '12px', color: '#64748B', marginTop: '2px' }}>Available to withdraw now</div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontSize: '20px', fontWeight: 900, color: '#0D9488' }}>₹8,640</div>
                <button onClick={() => setShowWithdraw(true)} style={{ background: '#0D9488', border: 'none', borderRadius: '8px', color: '#fff', fontSize: '11px', fontWeight: 700, padding: '4px 10px', cursor: 'pointer', marginTop: '4px', fontFamily: 'DM Sans, sans-serif' }}>
                  Withdraw →
                </button>
              </div>
            </div>
            ...
            {/* Transaction history */}
            <div style={{ fontSize: '11px', fontWeight: 700, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.6px', padding: '4px 16px 8px' }}>
              Payment History
            </div>
            {transactions.map(tx => {
              const s = statusStyle[tx.status]
              return (
                <div key={tx.id} onClick={() => openTx(tx)}
                  style={{ margin: '0 14px 8px', background: '#fff', borderRadius: '16px', padding: '14px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', border: '1px solid #E2E8F0', cursor: 'pointer', transition: 'background 0.15s' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{ width: '40px', height: '40px', borderRadius: '12px', background: '#EDFAF7', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', flexShrink: 0 }}>
                      {tx.icon}
                    </div>
                    <div>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '16px', fontWeight: 800, color: tx.status === 'paid' ? '#16A34A' : tx.status === 'pending' ? '#D97706' : '#2563EB' }}>
                      +₹{tx.amount}
                    </div>
                    <div style={{ fontSize: '11px', fontWeight: 700, color: s.color, marginTop: '2px' }}>
                      {s.label}
                    </div>
                  </div>
                </div>
          ...
          {/* Bottom Nav */}
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '80px', background: '#fff', borderTop: '1px solid #E2E8F0', display: 'flex', paddingBottom: '14px' }}>
            {[
              ...
              const on = t.label === 'Earnings'
              const c  = on ? '#0D9488' : '#94A3B8'
              return (
                <button key={t.href} onClick={() => router.push(t.href)} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '3px', border: 'none', background: 'transparent', cursor: 'pointer' }}>
                  {t.label === 'Home' && <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2.2" strokeLinecap="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>}
                  {t.label === 'Earnings' && <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>}
                  {t.label === 'Alerts' && <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>}
                  {t.label === 'Settings' && <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></svg>}
                  <span style={{ fontSize: '9px', fontWeight: 700, color: c }}>{t.label}</span>
                </button>
              )
            })}
          </div>
